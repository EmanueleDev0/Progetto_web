...
<body>
    ...
    <section class='post-header'>
        <form action="modifica_articolo.php" method="post" id="modifica">
            <div class='header-content post-container'>
                ...
                <img style="display: none;" src="" alt='' class='image-preview header-img' id="imagePreview">
    ...
    <section class='post-content post-container'>
        ...
        <p class='post-text'><textarea class="campo-trasparente accentra corpo-trasparente" type="text" id="corpo" name="corpo" placeholder="INSERISCI IL CORPO DELL'ARTICOLO" required><?= htmlspecialchars($corpo_articolo) ?></textarea></p>

        <!-- Sezione selezione categoria -->
        <div id="campi" class="accentra">
            <div id="categorie">
